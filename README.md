...
- **Security Tools:** Qualys, Splunk, Nessus (practice environment)  
- **Operating Systems:** Windows, Linux (Ubuntu/Kali)  
- **Programming/Scripting:** Python (automation), Bash (Linux)  
...
- 🔲 Complete Network Technician Path  
- 🔲 Earn ISC2 Cybersecurity Certification  
